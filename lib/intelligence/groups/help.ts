...
export const GROUPS_ENTRIES: HelpRecord[] = [
  ...
  },
  {
    ...
    what: 'The government’s own four digit grouping of everything it buys, with its written statement of what belongs in a class and what does not.',
  ...
  },
  {
    ...
    what: 'Whether a class really has more candidate corners than the map average, or only looks that way because we compared thirty classes at once.',
