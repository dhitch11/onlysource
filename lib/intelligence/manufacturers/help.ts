...
export const MANUFACTURER_ENTRIES: HelpRecord[] = [
  {
    ...
    what: 'A CAGE code identifies a location on a government list. One company can hold several of them, in different towns, under slightly different names.',
  ...
  },
  {
    ...
    what: 'The government’s own corporate complex file places these codes under a single association. This is a record we read, not a conclusion we drew.',
  ...
  },
  {
    ...
    what: 'The government does not link these codes, but they carry the same company name and the same contract administration office, so we believe one operator holds both.',
