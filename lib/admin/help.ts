...
export const T7_ENTRIES: HelpRecord[] = [
  ...
  },
  {
    ...
    how: 'Add a person, change a role, deactivate an account. Every change is written to the server and is still there on the next load. Adding somebody does not email them and does not create a separate sign in, because access to this build is one shared organization phrase.',
